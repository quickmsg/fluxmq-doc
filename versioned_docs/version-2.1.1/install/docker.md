...
```shell
docker run -it -d  -v /app/fluxmq.lic:/app/fluxmq.lic  -v /app/logs:/app/logs /app/config/config.yaml:/app/config/config.yaml  -p 8080:8080 -p 1883:1883 -p 8883:8883 fluxmq/enterprise:2.1.0
```
